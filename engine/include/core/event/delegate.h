...
template<auto>
struct delegate_fn_t {};

/*! @brief Constant of type connect_arg_t used to disambiguate calls. */
template<auto Func>
inline constexpr delegate_fn_t<Func> delegate_fn{};
    ...
    [[nodiscard]] auto wrap(std::index_sequence<Index...>) noexcept
    {
        return [](const void*, Args... args) -> Ret {
            ...
            return static_cast<Ret>(std::invoke(Candidate,
                std::forward<type_list_element_t<Index, type_list<Args...>>>(std::get<Index>(arguments))...));
        };
    }
...
public:
     ...
     * member.
     * @tparam Candidate Function or member to bind to the delegate.
     */
    template<auto Candidate>
    delegate(delegate_fn_t<Candidate>) noexcept
    {
        bind < Candidate > ();
    }
    ...
    delegate(delegate_fn_t<Candidate>, Type&& value_or_instance) noexcept
    {
        bind < Candidate > (std::forward<Type>(value_or_instance));
    }
     ...
     * When used to bind a free function with payload, its signature must be
     ...
     * @param payload User defined arbitrary data.
     */
    void bind(function_type* function, const void* payload = nullptr) noexcept
    {
        fn = function;
        data = payload;
    }
    ...
    {
        // todo ENTT_ASSERT(static_cast<bool>(*this), "Uninitialized delegate");
 ...
 */
template<auto Candidate>
delegate(delegate_fn_t<Candidate>)
 ...
 */
template<auto Candidate, typename Type>
delegate(delegate_fn_t<Candidate>, Type&&)
